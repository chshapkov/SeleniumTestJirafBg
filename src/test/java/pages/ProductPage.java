...
public class ProductPage extends BasePage {
    ...
    @FindBy(id = "blockcart-modal")//поправено от: (xpath = "/html/body/main/header/div[2]/div/div[2]")
    ...
    @FindBy(xpath = "/html/body/main/header/div[2]/div/div[1]/div[2]/div[2]/div/div[1]/a/span[1]") //span[@class='cart-products-count']
    ...
    public void addToCartAndContinueToShopping(){ //За да работи в теста следва да сложим фрейм и да инциалзираме уебелемент: driver.switchTo().frame(continueToShoppingButton);//todo
    ...
    public CartPage goToCartFromProductPage(){//За да работи в теста следва да сложим фрейм и да инциалзираме уебелемент: driver.switchTo().frame(goToCheckOutBtn);//todo
        addToCartButton.click();
